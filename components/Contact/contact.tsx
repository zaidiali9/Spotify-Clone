...
const ContactUs = () => {
    return (<>
    <section className="bg-cover bg-[url('/assets/breadcumb.jpg')]">
  <div id="map" className="relative h-[350px] overflow-hidden bg-cover bg-[50%] bg-no-repeat">
    <Navbar/>
    <h1 className='text-white font-bold text-4xl m-10 text-center tracking-widest '>CONTACT US</h1>
  </div>  
  <div className="px-20 bg-cover pb-10">
  <div className="container px-6 md:px-12 mb-32">
    <div
      className="block rounded-lg bg-[#ffffff7e] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]  md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px] border border-gray-300">
      <div className="flex flex-wrap">
        ...
        <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d27218.573677293458!2d74.31732833860934!3d31.48783991212622!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391903f08ebc7e8b%3A0x47e934f4cd34790!2sFAST%20NUCES%20Lahore!5e0!3m2!1sen!2s!4v1713629917215!5m2!1sen!2s"
